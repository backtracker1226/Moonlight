...
<!-- 다음오픈에디터 라이브러리 -->
<link rel="stylesheet" href="/resources/daumeditor/css/popup.css" type="text/css"
	charset="utf-8" />
...
<body onload="initUploader();">
	...
	<div class="wrapper">
					...
					<form id=daumOpenEditorForm encType=multipart/form-data method=post
						...
						<div class=file>
							<input disabled class=file-text id="fname"> <label class=file-btn
								for=uploadInputBox style="height: 33px">사진첨부</label> <input id=uploadInputBox
		...
		<div class="footer" style="margin: 0px;padding: 0px;">
			...
			<ul>
				<li class="submit"><a href="#" title="등록" id="regBtn"
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-body">
					<h4 style="text-align: center;" id="modalText">jpg, gif, png, bmp 확장자만 업로드 가능합니다.</h4>
